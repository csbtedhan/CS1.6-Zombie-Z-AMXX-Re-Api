...
load_config()
{
	if(!file_exists("script/custom_item/weapon_bizon.txt"))
	{
		delete_file("script/custom_item/weapon_bizon.txt")
		new File = fopen("script/custom_item/weapon_bizon.txt", "a")
	...
	file = fopen("script/custom_item/weapon_bizon.txt", "rt")
