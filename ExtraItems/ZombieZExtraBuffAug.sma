...
new c_wpn_damage = 130
new Float:c_wpn_speed = 0.035
new Float:c_wpn_spreadmult = 0.0015
...
load_config()
{
	if(!file_exists("script/custom_item/weapon_buffaug.txt"))
	{
		delete_file("script/custom_item/weapon_buffaug.txt")
		new File = fopen("script/custom_item/weapon_buffaug.txt", "a")
	...
	file = fopen("script/custom_item/weapon_buffaug.txt", "rt")
