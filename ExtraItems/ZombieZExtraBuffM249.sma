...
new c_wpn_damage = 190
new c_wpn_bdamage = 750
new c_wpn_bpenetrate = 4
new Float:c_wpn_speed = 0.065
...
load_config()
{
	if(!file_exists("script/custom_item/weapon_buffm249.txt"))
	{
		delete_file("script/custom_item/weapon_buffm249.txt")
		new File = fopen("script/custom_item/weapon_buffm249.txt", "a")
	...
	file = fopen("script/custom_item/weapon_buffm249.txt", "rt")
...
public GiveBuffM4(id)
{
	...
	if(pev_valid(iWpn) && get_pdata_int(iWpn, 43) == CSW_M249)
