...
new c_wpn_damage = 100
new c_wpn_bdamage = 450
new c_wpn_bpenetrate = 3
new Float:c_wpn_speed = 0.075
new Float:c_wpn_bspeed = 0.2
...
load_config()
{
	if(!file_exists("script/custom_item/weapon_buffm4.txt"))
	{
		delete_file("script/custom_item/weapon_buffm4.txt")
		new File = fopen("script/custom_item/weapon_buffm4.txt", "a")
	...
	file = fopen("script/custom_item/weapon_buffm4.txt", "rt")
...
public RG_FireBullets3(iAttacker, Float:vecSrc[3], Float:vecDirShooting[3], Float:vecSpread, Float:flDistance, iPenetration, iBulletType, iDamage, Float:flRangeModifier, pevAttacker, bool:bPistol, shared_rand)
{
	...
	SetHookChainArg(8, ATYPE_INTEGER, pev(iAttacker, pev_fov)  < 90 ? c_wpn_bdamage : c_wpn_damage)
	SetHookChainArg(6, ATYPE_INTEGER, pev(iAttacker, pev_fov)  < 90 ? c_wpn_bpenetrate : c_wpn_penetrate)
