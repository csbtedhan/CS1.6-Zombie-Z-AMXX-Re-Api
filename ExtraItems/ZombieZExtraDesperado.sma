...
new c_wpn_damage = 210
new Float:c_wpn_speed = 0.12
new Float:c_wpn_spreadmult = 0.002
...
load_config()
{
	if(!file_exists("script/custom_item/weapon_desperado.txt"))
	{
		delete_file("script/custom_item/weapon_desperado.txt")
		new File = fopen("script/custom_item/weapon_desperado.txt", "a")
	...
	file = fopen("script/custom_item/weapon_desperado.txt", "rt")
...
public GiveDSP(id)
{
	...
	if(pev_valid(Ent)) 
	{
		...
		set_pev(Ent, pev_iuser3, c_wpn_clip)
		set_pev(Ent, pev_iuser4, c_wpn_clip)
	}
}
...
public fw_CmdStart(id, uc_handle, seed)
{
	...
	if((CurButton&IN_ATTACK) && get_pdata_float(id, 83, 5) <= 0.0)
	{
		...
		if(pev(Ent, pev_iuser1))
		{
			...
			set_pdata_float(Ent, 48, c_wpn_speed + 0.5, 4);
