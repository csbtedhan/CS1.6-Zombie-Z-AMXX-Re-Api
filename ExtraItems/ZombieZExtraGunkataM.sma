...
load_config()
{
	if(!file_exists("script/custom_item/weapon_gunkatam.txt"))
	{
		delete_file("script/custom_item/weapon_gunkatam.txt")
		new File = fopen("script/custom_item/weapon_gunkatam.txt", "a")
	...
	file = fopen("script/custom_item/weapon_gunkatam.txt", "rt")
