...
new c_wpn_clip = 30
new c_wpn_maxfire = 10
new c_wpn_damage = 60
new c_wpn_shotcount = 6
new Float:c_wpn_firedamage = 400.0
new Float:c_wpn_fireradius = 100.0
new Float:c_wpn_fireduration = 0.7
...
load_config()
{
	if(!file_exists("script/custom_item/weapon_sgmissile.txt"))
	{
		delete_file("script/custom_item/weapon_sgmissile.txt")
		new File = fopen("script/custom_item/weapon_sgmissile.txt", "a")
	...
	file = fopen("script/custom_item/weapon_sgmissile.txt", "rt")
...
{
	if(!is_user_connected(id) || get_user_weapon(id) != CSW_SGMISSILE || !Get_BitVar(g_HadWpn, id))
		return
...
public fw_Item_PostFrame(ent)
{
	...
	if(pev(ent, pev_iuser1) < c_wpn_maxfire && pev(ent, pev_fuser1) <= get_gametime())
	{
...
public fw_Touch(ent, id)
{
	...
	DoRadiusDamage(pevAttacker, ent, vOrigin, c_wpn_firedamage, c_wpn_fireradius);
