...
load_config()
{
	if(!file_exists("script/custom_item/weapon_starchasersr.txt"))
	{
		delete_file("script/custom_item/weapon_starchasersr.txt")
		new File = fopen("script/custom_item/weapon_starchasersr.txt", "a")
	...
	file = fopen("script/custom_item/weapon_starchasersr.txt", "rt")
