...
new const szVoidModels[3][] = { "models/zbz/wpn/p_voidpistol.mdl" , "models/zbz/wpn/v_voidpistol.mdl" , "models/zbz/wpn/w_secgroup1.mdl" }
...
{
	"models/zbz/wpn/ef_blackhole.mdl",
	"models/zbz/wpn/ef_blackhole_projectile.mdl",
